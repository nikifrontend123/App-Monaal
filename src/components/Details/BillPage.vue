<template>
    <div>
        <div>
            ...
            <DetailNavLink active="Bill"></DetailNavLink>
            <SearchBar></SearchBar>
                ...
                <div class="offcanvas offcanvas-end show" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop"
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        ...
                        <div class="d-flex justify-content-end w-100">
                            <button type="button" class="btn" @click="hideDetailbill()"><i class="bi bi-x fs-3"></i></button>
                        </div>
                    </div>
                    <div class="overflow-scroll">
                        <div class="d-flex w-100 py-2 border-bottom container">
                            <div class="d-flex w-100 ">
                                <div class="border border-2 border-dark rounded-circle">
                                    <p class="m-0 d-flex justify-content-center align-items-center fw-bold"
                                        style="width: 60px; height: 60px; border-radius: 50px;">{{ activeDetailbill.date }}</p>
                                </div>
                                <div>
...
export default {
    components: { DetailNavLink, StageStepper, SearchBar },
    data() {
        return {
    ...
    computed: {
        detailbills() {
            return this.$store.getters.getDetailbills
        },
        activeDetailbill() {
            return this.$store.getters.getDetailbill;
        },
    },
    methods: {
        showDetailbill(dtailbill) {
            return this.$store.dispatch('selectDetailbill', dtailbill);
        },
        hideDetailbill() {
            return this.$store.dispatch('hideDetailbill');
        },
    }
}
</script>
