...
export default {
    name: "NewPage",
    components: { ClothCard, BtnChange, SearchBar, SupplierLink },
    data() {
        return {
    ...
    computed: {
        chatss() {
            return this.$store.getters.getChatss;
        }
    }
}
</script>
